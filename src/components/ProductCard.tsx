...
const ProductCard: React.FC<{ product: Product }> = ({ product }) => {
  ...
  return (
    <Link to={`/producto/${product?.id}`}>
      <div className="cursor-pointer border-[0.5px] border-gray-300 rounded-xl overflow-hidden p-4 text-center md:w-[230px]  bg-white hover:shadow-lg transition-all active:opacity-70 hover:opacity-70">
